...
var overLayer = cc.LayerColor.extend({
    ...
    init:function ()
    {
        ...
        if(this.gameLevel==0)
        {
            shareText="我在《全民挑战疑难汉字》中一个字也没认出来，别拦我，感觉不会再爱了！";
        }
        else if(this.gameLevel>0&&this.gameLevel<=5)
        {
            shareText="我在《全民挑战疑难汉字》中竟然认出"+this.gameLevel+"个，终于没给语文老师丢脸！";
        }
        else if(this.gameLevel>5&&this.gameLevel<=10)
        {
            shareText="我在《全民挑战疑难汉字》中竟然认出"+this.gameLevel+"个，没想到我知识如此渊博！";
        }
        else if(this.gameLevel>10&&this.gameLevel<=15)
        {
            shareText="我在《全民挑战疑难汉字》中竟然认出"+this.gameLevel+"个，堪比文学叫兽！" ;
        }
        else if(this.gameLevel>15&&this.gameLevel<=19)
        {
            shareText="我在《全民挑战疑难汉字》中竟然认出"+this.gameLevel+"个，请考古部门联系我！";
        }
        else
        {
            shareText="我在《全民挑战疑难汉字》中竟然认出全部汉字，是时候考虑我的身世了！";
        }
