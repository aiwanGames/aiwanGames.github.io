var mainLayer = cc.LayerColor.extend({
    ...
    init:function ()
    {
        ...
        fangqimenu.setPosition(cc.p(this.winsize.width*0.25,this.winsize.height*0.3));
        this.addChild(fangqimenu, 1);
        var chakankaishiItem = cc.MenuItemImage.create(s_img02,s_img02,this.chakanDaAn,this);
        var chakanmenu = cc.Menu.create(chakankaishiItem);
        chakanmenu.setPosition(cc.p(this.winsize.width*0.75,this.winsize.height*0.3));
        ...
        //答案数组
        this.anserArray=[1,3,1,2,2,3,1,2,3,1,1,2,3,1,2,2,2,1,2,2,1,3,1,2,3,1,3,3,1,2];
        ...
        //发音和字义
        this.sp_label1=cc.LabelTTF.create("","Arial",27);
        ...
        this.sp_label2=cc.LabelTTF.create("","Arial",27);
        ...
        //答题数量
        this.sp_count=cc.LabelTTF.create("01/30","Arial",32);
    ...
    reLoadFontInfo:function()
    {
        ...
        if(this.fontIndex<10)
            this.sp_count.setString("0"+this.fontIndex+"/30");
        else
            this.sp_count.setString(this.fontIndex+"/30");
        this.answerSprite.setVisible(false);
        this.sp_label1.setString("");
        this.sp_label2.setString("");
        this.ischakan=false;
        var fontName="";
        var Alabel="";
        var Blabel="";
        ...
        switch(this.fontIndex)
        {
            ...
            case 5:fontName="img_chu.png";Alabel="A.shu";Blabel="B.chu";Clabel="C.chou";break;
            ...
            case 14:fontName="img_miao.png";Alabel="A.miao";Blabel="B.shui";Clabel="C.liu";break;
            ...
            case 28:fontName="img_xun.png";Alabel="A.quan";Blabel="B.tang";Clabel="C.xun";break;
            case 29:fontName="img_zhe.png";Alabel="A.zhe";Blabel="B.zhen";Clabel="C.zhan";break;
            case 30:fontName="img_zhuan.png";Alabel="A.sun";Blabel="B.zhuan";Clabel="C.zhuang";break;
        }
        //文字
    ...
    chakanDaAn:function()
    {
        ...
        if(this.ischakan)
        {
            ...
            switch (this.fontIndex) {
                ...
                case 30:
                    label1 = "发音: zhuan(三声)";
                    label2 = "字义: 形容谨慎,现指男性成功三大标志:房子,车子,妻子";
                    break;
            }
            this.sp_label1.setString(label1);
            this.sp_label2.setString(label2);
            var ac0 = cc.DelayTime.create(1.8);
            var ac1 = cc.CallFunc.create(this.enableChoice, this);
            this.sp_label2.runAction(cc.Sequence.create(ac0, ac1));
        }
    },
    ...
    checkChoice:function(_fontIndex,_yourCoice,_pos)
    {
        ...
        var ac2=cc.DelayTime.create(0.5);
