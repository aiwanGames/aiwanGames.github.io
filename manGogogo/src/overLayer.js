...
var overLayer = cc.LayerColor.extend({
    ...
    init:function ()
    {
        ...
        sp_hand.setPosition(cc.p(this.winsize.width*0.2,this.winsize.height*0.8));
        this.addChild(sp_hand,1);
        var ac0=cc.MoveTo.create(0.4,cc.p(this.winsize.width*0.15,this.winsize.height*0.85));
        var ac1=cc.MoveTo.create(0.4,cc.p(this.winsize.width*0.2,this.winsize.height*0.8));
