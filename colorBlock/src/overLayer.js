...
var overLayer = cc.LayerColor.extend({
    ...
    init:function ()
    {
        ...
        sp_back1.setPosition(cc.p(this.winsize.width*0.5,this.winsize.height*0.57));
        ...
        sp_hand.setPosition(cc.p(this.winsize.width*0.87,this.winsize.height*0.90));
        sp_hand.setRotation(30.0);
        sp_hand.setScale(0.8);
        this.addChild(sp_hand,1);
        var ac0=cc.MoveTo.create(0.4,cc.p(this.winsize.width*0.92,this.winsize.height*0.94));
        var ac1=cc.MoveTo.create(0.4,cc.p(this.winsize.width*0.87,this.winsize.height*0.90));
        ...
        sp_gameLevel.setPosition(cc.p(this.winsize.width*0.5,this.winsize.height*0.62));
        ...
        sp_comment.setPosition(cc.p(this.winsize.width*0.5,this.winsize.height*0.52));
